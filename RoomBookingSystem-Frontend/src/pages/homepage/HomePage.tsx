            ...
            <div className={"homepage-wrapper"}>
                ...
                <div className="content-container">
                    <div className={"text-over-image"}>
                        <div className={"text1"}>Experience unparalleled luxury at a price that fits your budget</div>
                        <div className={"text2"}>Enjoy Lavish Comfort at an Affordable Price</div>
                    </div>
                    {showLoginPage && (
